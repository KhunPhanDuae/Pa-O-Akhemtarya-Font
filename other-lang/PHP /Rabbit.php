...
';
    ...
    public static function uni2zg($unicode)
    {
        ...
        return self::output_paoh_zawgyi(self::replaceWithRule($rule, self::input_paoh_unicode($unicode)));
    }
    ...
    public static function zg2uni($zawgyi)
    {
        ...
        return self::output_paoh_unicode(self::replaceWithRule($rule, self::input_paoh_zawgyi($zawgyi)));
    }
    ...
    //Mai Ngar => zMaiNgarz
    private static function input_paoh_zawgyi($output){
        $rule = json_decode("[{\"from\":\"\\u109E\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u1052\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u109F\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u1053\",\"to\":\"zMaiNgarz\"}]",true);
        return self::replaceWithRule($rule, $output);
    }

    private static function input_paoh_unicode($output){
        $rule = json_decode("[{\"from\":\"\\u108F\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\uAA7B\",\"to\":\"zMaiNgarz\"}]",true);
        return self::replaceWithRule($rule, $output);
    }
